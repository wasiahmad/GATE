...
from clie.modules.multi_head_attn import MultiHeadedAttention
from clie.modules.position_ffn import PositionwiseFeedForward
from clie.encoders.encoder import EncoderBase
from clie.utils.misc import sequence_mask
...
class TransformerEncoder(EncoderBase):
    ...
    def forward(self, src, lengths=None, **kwargs):
        ...
        for i in range(self.num_layers):
            out, attn_per_head = self.layer[i](out, mask, **kwargs)
